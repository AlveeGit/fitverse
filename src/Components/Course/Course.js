...
const Course = (props) => {
    ...
    return (
        ...
        <div className='bg-gray-200 relative m-3 rounded-md p-3 '>
            ...
            <h4 className='h-20 text-2xl font-bold mb-3'>Course : {name}</h4>
            ...
            <button onClick={() => addToList(time)} className='bg-gray-500 mt-4 w-full rounded-md py-2 text-white font-bold absolute inset-x-0 bottom-0'>Add to List</button>
